...
var myMap = L.map("map", {
  center: [36.7783,-119.4179], //lat long of california
  zoom: 5,
});
...
// pulling earthquake data over the past 30 days - all earthquakes
...
// set up the legend in the bottom right of the map
